...
name: tailwind-4
description: >
  Use for Tailwind CSS utility classes, responsive design, and styling patterns.
  Does NOT cover component architecture (see react-patterns) or design system standards (see rhinolabs-standards).
license: Apache-2.0
metadata:
...
- **rhinolabs-standards** - For all code quality and design system standards
- **rhinolabs-architecture** - For architecture decisions
- **rhinolabs-security** - For security-related styling (XSS prevention, etc.)

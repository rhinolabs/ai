...
name: zod-4
description: >
  Use for Zod schema validation, type inference, and error handling.
  Does NOT cover API architecture (see rhinolabs-architecture) or security validation rules (see rhinolabs-security).
license: Apache-2.0
metadata:
...
- **rhinolabs-standards** - For all code quality standards
- **rhinolabs-architecture** - For validation architecture decisions
- **rhinolabs-security** - For security validation requirements (password strength, input sanitization, etc.)

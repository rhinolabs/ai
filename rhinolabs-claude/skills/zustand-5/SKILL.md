...
name: zustand-5
description: >
  Use for Zustand store creation, actions, selectors, and persistence.
  Does NOT cover state management architecture decisions (see rhinolabs-architecture).
license: Apache-2.0
metadata:
...
- **rhinolabs-security** - For sensitive data in state

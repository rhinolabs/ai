...
name: playwright
description: >
  Use for Playwright-specific APIs, E2E test patterns, Page Objects, and selectors.
  Does NOT cover general testing strategy (see testing-strategies) or quality standards (see rhinolabs-standards).
license: Apache-2.0
metadata:
